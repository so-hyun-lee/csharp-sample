...
public class StringFormatBasic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string.Format(fmt, "Marvel","Stan Lee", "Iron Man");
        string.Format(fmt, "Hanbit","Sanghyun Park", "This is C#");
        string.Format(fmt, "Prentice Hall","K&R", "The C Programming Language");
//----------

        DateTime dt = new DateTime(2023,11,27,18,11,11);
